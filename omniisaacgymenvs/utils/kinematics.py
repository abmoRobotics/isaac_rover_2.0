...
# This is the old kinematics function
# The inputs are unitless. The dimensions are for the exomy rover.
# The code is a mess - do NOT try to understand the code! If you do anyways, it will take around a day.
@torch.jit.script
